...
public abstract class XbmcRequest {
	
	private SharedPreferences preferences;
	
	public XbmcRequest(SharedPreferences preferences) {
	...
	protected JSONObject jsonRequest(JSONObject content) throws Exception {
		...
		if(entity != null)  {
			...
			if(Log.isLoggable(XbmcRequest.class.getSimpleName(), Log.DEBUG)) {
				Log.v(XbmcRequest.class.getSimpleName(), responseContent);
			}
		...
		if(Log.isLoggable(XbmcRequest.class.getSimpleName(), Log.DEBUG)) {
			Log.v(XbmcRequest.class.getSimpleName(), response.getStatusLine().toString());
		}
